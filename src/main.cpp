...
unsigned char pchMessageStart[4] = { 0xcd, 0xc4, 0x2f, 0x8d };
unsigned int nStakeMinAge = 60 * 60 * 24*3;	
unsigned int nStakeMaxAge = 60 * 60 * 24*90;
unsigned int nStakeTargetSpacing = 60;			

int64 nChainStartTime = 1517312806;
...
const string strMessageMagic = "CryptoCashCoin Signed Message:\n";
...
int64 GetProofOfWorkReward(int nHeight, int64 nFees, const CBlockIndex* pindex)
{
     ...
     if(nHeight==1)
       nSubsidy = 12000000 * COIN; //Premin: 10M
...
int64 GetProofOfStakeReward(int64 nCoinAge, unsigned int nBits, unsigned int nTime, int nHeight)
{
   int64 nSubsidy = 0;
        ...
        nSubsidy = (nCoinAge * 0.5 * COIN )/ 365;
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in CryptoCashCoin
    bool fStrictPayToScriptHash = true; // Always active in CryptoCashCoin
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "CryptoCashCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "2018/1/30,CryptoCashCoin is upcoming release wish is a great coin!";
        CTransaction txNew;
      ...
      if (true  && (block.GetHash() != hashGenesisBlock))
        ...
        assert(block.hashMerkleRoot == uint256("0xde8427433d98bb813a01a0417290bd989dca306eefda80c0dffc6b2a564114a5"));
